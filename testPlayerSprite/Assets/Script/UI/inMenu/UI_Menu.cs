...
public class UI_Menu : MonoBehaviour {
    ...
    static GameObject[] MenuItems = new GameObject[6];      //メニューの項目
    static GameObject[] ItemWindows = new GameObject[6];    //項目ごとの開くべきウィンドウ
    int choiceElement;
	...
	void Start () {
        ...
        MenuItems[5] = GameObject.Find("Talk");

    }

    void Awake()
    {
        ItemWindows[1] = GameObject.Find("CharacterWindow");
